...
Julia Online Sandbox:
<https://www.coderunbox.com/playground/playcode-julia>
...
```{julia dataframe2, eval=TRUE, echo=TRUE}
df.age
df[:, 1]
...
```{julia sym,eval=FALSE, echo=TRUE}
using Symbolics, Nemo

@variables x a b
expand( (x + a) * (x + b) )
symbolic_solve ( 4*x^2 - 2*x - 1)
...
```{julia installagain2, eval=FALSE, echo=TRUE}
using Pkg
Pkg.add(["StructuralEquationModels", "CSV", "Distributions", "DataFrames", "StableRNGs"])
```
